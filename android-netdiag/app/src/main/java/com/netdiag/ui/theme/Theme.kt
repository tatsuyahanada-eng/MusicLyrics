...
/**
 * Fixed dark "terminal" theme: a gray/black background with phosphor text.
 * Dynamic (Material You) colours are intentionally disabled so the retro
 * character-terminal look is consistent across devices.
 */
@Composable
fun NetDiagTheme(
