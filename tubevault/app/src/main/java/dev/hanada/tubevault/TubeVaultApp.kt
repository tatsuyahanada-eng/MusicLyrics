...
import dev.hanada.tubevault.lyrics.LyricsRepository
...
class AppContainer(private val app: Application) {
    ...
    val lyrics: LyricsController by lazy {
        LyricsController(playback, library, LyricsRepository(database.lyricsCacheDao()))
    }
