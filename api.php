...
switch ($action) {
  ...
  case 'ai_chat': {
    ...
    $prompt = "あなたは社内作業マニュアルのアシスタントです。利用者が「こうしたい」と相談してくるので、"
      ...
      . "例えば【関連項目】の中に機種名の異なる複数の手順（例：「Relier（ルリエ）」用と「Monstera（モンステラ）」用のように、"
      . "見た目は似た相談でも機種によって手順が違うもの）が含まれていて、利用者の発言だけではどちらの機種か決められないときは、"
      . "分かったふりをして手順を混ぜて答えるのではなく、必ず聞き返して機種を確認してください。\n"
      . "ASK: 利用者への確認の質問（50字以内）\n"
      . "- 選択肢1\n"
      . "- 選択肢2\n"
      . "選択肢は2〜4個で、必ず【関連項目】に実在する内容から作ってください。対象が明らかなときは聞き返さないこと。\n"
      . "聞き返して利用者が答えたら、その回答をもとに、正確な手順を簡潔にまとめて答えてください。\n\n"
      . "【これまでの会話】\n" . $convo . "\n"
      . "【関連項目】\n" . implode("\n\n", $secLines);
